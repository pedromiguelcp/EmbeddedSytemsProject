...
#include <memory>
#include "../CarDashboard/network.h"
...
QT_MOC_LITERAL(1, 8, 12), // "readyweather"
QT_MOC_LITERAL(2, 21, 0), // ""
QT_MOC_LITERAL(3, 22, 9), // "weather_t"
QT_MOC_LITERAL(4, 32, 13), // "weatherValues"
QT_MOC_LITERAL(5, 46, 9), // "readynews"
QT_MOC_LITERAL(6, 56, 8), // "news_t[]"
QT_MOC_LITERAL(7, 65, 10), // "newsValues"
QT_MOC_LITERAL(8, 76, 14), // "refreshWeather"
QT_MOC_LITERAL(9, 91, 11), // "refreshNews"
QT_MOC_LITERAL(10, 103, 12), // "printweather"
QT_MOC_LITERAL(11, 116, 9) // "printnews"

    },
    "Network\0readyweather\0\0weather_t\0"
...
void Network::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (Network::*)(weather_t );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Network::readyweather)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (Network::*)(news_t []);
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Network::readynews)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void Network::readyweather(weather_t _t1)
{
...
// SIGNAL 1
void Network::readynews(news_t _t1[])
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(std::addressof(_t1))) };
