...
#include "../CarDashboard/weather.h"
...
QT_MOC_LITERAL(1, 8, 5), // "ready"
QT_MOC_LITERAL(2, 14, 0), // ""
QT_MOC_LITERAL(3, 15, 9), // "weather_t"
QT_MOC_LITERAL(4, 25, 13), // "weatherValues"
QT_MOC_LITERAL(5, 39, 14), // "refreshWeather"
QT_MOC_LITERAL(6, 54, 5) // "print"

    },
    "Weather\0ready\0\0weather_t\0weatherValues\0"
    "refreshWeather\0print"
};
...
void Weather::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->ready((*reinterpret_cast< weather_t(*)>(_a[1]))); break;
        case 1: _t->refreshWeather(); break;
        ...
        {
            using _t = void (Weather::*)(weather_t );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Weather::ready)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void Weather::ready(weather_t _t1)
{
